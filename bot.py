...
async def auto_shift_reminders():
    ...
    ZoneInfo("Europe/Rome")
        ...
        # Если есть смены на сегодня
        if today in shift_schedule:

            shifts = shift_schedule[today]

            for shift_time, workers in shifts.items():
                ...
                if current_time == reminder_times[shift_time]:
                    ...
                    await bot.send_message(
                        ...
                        f"Через 30 минут смена ({shift_time})\n\n"

                        f"🟢 Точка 1 — {workers['point1']}\n"
                        f"🔴 Точка 2 — {workers['point2']}\n\n"
